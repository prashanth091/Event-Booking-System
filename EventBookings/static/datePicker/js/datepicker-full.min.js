!(function () {
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        (c = Object.assign({ format: j, weekStart: H }, r[T])),
          ...
          m === t.weekStart &&
            ((m = n.weekStart = c.weekStart), (n.weekEnd = P(c.weekStart)));
      }
    }
    if (a.format) {
    ...
    if (
      (void 0 !== a.minDate &&
        ...
        delete a.minDate),
      void 0 !== a.maxDate &&
        ((k = null === a.maxDate ? void 0 : R(a.maxDate, d, c, k)),
        delete a.maxDate),
      k < y
    ...
    if (
      (a.daysOfWeekDisabled &&
        ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce($, [])),
  ...
  function re(t, i) {
    ...
    if (
      ...
      void 0 !== i.todayBtn &&
        (i.todayBtn ? _(t.controls.todayBtn) : W(t.controls.todayBtn)),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn ? _(t.controls.clearBtn) : W(t.controls.clearBtn));
  }
  function de(e) {
